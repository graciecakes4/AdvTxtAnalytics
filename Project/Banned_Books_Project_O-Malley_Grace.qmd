...
#readr::write_csv(books_not_banned_df, "Project/data/books_not_banned_df.csv")
...
#readr::write_csv(books_not_banned_text_cleaned_df, "Project/data/books_not_banned_text_cleaned_df.csv")

#readr::read_csv("Project/data/books_not_banned_text_cleaned_df.csv") -> books_not_banned_text_cleaned_df
#books_not_banned_text_cleaned_df <- books_not_banned_text_cleaned_df %>%
#  dplyr::mutate(text = purrr::map(text, ~ .x)) %>% 
#  dplyr::mutate(gutenberg_id = as.character(gutenberg_id))
...
#readr::write_csv(complete_book_texts_cleaned_df, "Project/data/complete_book_texts_cleaned_df.csv")
