...
test_data_metadata <- readr::read_csv("Project/data/test_data_metadata.csv")
...
```{r feature matrix read in}

feature_matrix <- readr::read_csv("Project/data/feature_matrix.csv")
...
ggplot2::ggplot(data = importance_df, ggplot2::aes(x = Feature, y = Gain)) +
  ...
  ggplot2::coord_flip() +
  ggplot2::scale_y_continuous("Gain", expand = c(0, 0), limits = c(0, 0.28)) +
...
labeled_test_data <- readr::read_csv("Project/data/labeled_test_data.csv")
