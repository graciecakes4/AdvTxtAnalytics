...
theme_dictionary_long <- list(
  ...
  violence = c(
    ...
    "abuse", "physical violence", "murder", "suicide", "assault", "war", "fight", 
    "bullying", "domestic violence", "relationship violence", "sexual violence"
  ),
...
1. Find a better way to visualize
