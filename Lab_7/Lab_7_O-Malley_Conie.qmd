...
job_data <- readr::read_csv("Lab_7/data/job_data.csv")
utils::head(job_data, 10) # view created data
data_to_plot <- job_data %>%
  dplyr::group_by(Region, Year) 

# Load shapefiles for the choropleth map
esri_shapefile <- sf::read_sf("Lab_7/data/world-shape-files/")
geojson_shapefile <- sf::read_sf("Lab_7/data/world-geojson.json")
shp_as_sf <- sf::read_sf("Lab_7/data/world-shape-files/")
